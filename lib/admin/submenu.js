$(document).ready(function(){
	...
	var url_tbl 		= site_url+"admin/submenu/table/";
	var url_add 		= site_url+"admin/submenu/add/";
	var url_edit 		= site_url+"admin/submenu/edit/";
	var url_act_add 	= site_url+"admin/submenu/act_add";
	var url_act_edit 	= site_url+"admin/submenu/act_edit";
	var url_act_del 	= site_url+"admin/submenu/act_del";
	...
	$(document).on('click','#delete_btn',function(e){
		...
		swal({
			title: 'Anda Yakin ?',
			text: 'Sub Menu '+name+' akan di hapus ?',
			type: 'question',
