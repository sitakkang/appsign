$(document).ready(function(){
	...
	var url_tbl 		= site_url+"admin/user/table";
	var url_add 		= site_url+"admin/user/add";
	var url_edit 		= site_url+"admin/user/edit";
	var url_reset 		= site_url+"admin/user/reset";
	var url_act_add 	= site_url+"admin/user/act_add";
	var url_act_edit 	= site_url+"admin/user/act_edit";
	var url_act_del 	= site_url+"admin/user/act_del";
	var url_act_res 	= site_url+"admin/user/act_reset";
