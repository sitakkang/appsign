$(document).ready(function(){
	...
	var url_tbl 		= site_url+"apps/surat_masuk/table";
	var url_add 		= site_url+"apps/surat_masuk/add";
	var url_edit 		= site_url+"apps/surat_masuk/edit/";
	var url_act_add 	= site_url+"apps/surat_masuk/act_add";
	var url_act_edit 	= site_url+"apps/surat_masuk/act_edit";
	var url_act_del 	= site_url+"apps/surat_masuk/act_del";
	var url_form_attach	= site_url+"apps/surat_masuk/upload_attach/";
	var url_act_attach	= site_url+"apps/surat_masuk/act_upload_attach";
	var url_form_send	= site_url+"apps/surat_masuk/send_mail/";
	var url_act_send	= site_url+"apps/surat_masuk/act_send_mail/";
	var url_status		= site_url+"apps/surat_masuk/view_status/";
	var url_act_status	= site_url+"apps/surat_masuk/act_status";
