...
class Surat_keluar extends CI_Controller {
    ...
    public function table()
    {
        ...
        $get_all = $this->db->query('SELECT id_surat_keluar, jenis, no_surat, perihal, diusulkan, disetujui, tgl_kirim, status, attach1, document_id, approval_status FROM app_surat_keluar where user='. $user_id .' ORDER BY id_surat_keluar DESC');
