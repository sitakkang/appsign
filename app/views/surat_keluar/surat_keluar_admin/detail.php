<div class="form-group">
    ...
    <div class="form-control"><?=$this->m_surat_keluar_admin->label_jenis_ttd($id->jenis_ttd);?></div>
</div>
<div class="form-group">
    <label class="control-label">User </label>
    <input type="text" class="form-control" value="<?=$this->m_surat_keluar_admin->get_user($id->user);?>" readonly>
</div>
<?php
...
?>
    <div class="form-group">
        ...
        <input type="text" class="form-control" value="<?=$this->m_surat_keluar_admin->get_signer($id->signer);?>" readonly/>
    </div>
<?php
}
?>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" value="<?=$this->m_surat_keluar_admin->penerima_surat($id->disetujui);?>" readonly>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="form-control"><?=$this->m_surat_keluar_admin->label_status_keluar($id->status, $id->id_surat_keluar);?></div>
</div>
<div class="form-group">
